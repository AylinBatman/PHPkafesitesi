                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
									...
									<form role="form" action="<?php echo base_url();?>admin/uye_guncelle/<?php echo $veri[0]->user_id ?>" method="POST">                                        
                                        ...
                                        <div class="form-group">
                                            <label>TELEFON</label>
                                            <input class="form-control" id="user_phone" name="user_phone" value="<?php echo $veri[0]->user_phone?>" placeholder="Telefon Giriniz">
                                        </div> 

										<div class="form-group">
                                            <label>CİNSiYET</label>
                                            <input class="form-control" id="user_gender" name="user_gender" value="<?php echo $veri[0]->user_gender?>" placeholder="cinsiyet Giriniz">
                                        </div>
