...
<head>
    ...
    <title>ENSA Yönetim Paneli</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url()?>admin">ENSA Admin Paneli</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages"> 
                        <li>
                            <a class="text-center" href="<?php echo base_url()?>admin/mesajlistele"
...
echo $session_data['adsoy'];?>						<i class="fa fa-caret-down"></i>
                    </a>
