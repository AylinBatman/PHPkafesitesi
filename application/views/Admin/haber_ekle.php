...
<div id="page-wrapper">
				...
				<div class="panel-body">
                     <div class="row">
                       <div class="col-lg-6">
						<form role="form" action="haber_kaydet" method="POST">  
									<div class="form-group">
                                            <label>BASLIK</label>
                                            <input class="form-control" id="haber_baslik" name="haber_baslik" placeholder="Başlık Giriniz">
                                       </div>
						<div class="form-group">
						...
						<button type="submit" value="haber_kaydet" class="btn btn-outline btn-primary btn-lg btn-block">KAYDET</button>
