                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          <i class="fa fa-user"></i> Üye Kayıt Tablosu
						   <a href="<?php echo base_url()?>admin/uye_kaydetme"> Üye Ekle</a><br>
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									foreach ($veri as $rs){
										$i++;
                                         ...
                                         <td class="center"><?=$rs->uye_yetki?></td>
										 <td><?php echo anchor(base_url()."admin/uye_sil/".$rs->uye_id, "SİL");?></td>
										 <td><?php echo anchor(base_url()."admin/uye_duzenle/".$rs->uye_id, "Düzenle");?></td>
                                        </tr>								
											<?php } ?>				
